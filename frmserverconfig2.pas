...
begin
  ...
  SaveDir := IncludeTrailingPathDelimiter(ExtractFilePath(ParamStr(0)) + 'temp\cfgs3\');
...
begin
  ...
  try
    DestinoServidor := Ini.ReadString('UpdateMod', 'destinoserver3', '');
...
procedure TForm21.Label33Click(Sender: TObject);
begin
