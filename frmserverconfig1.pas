...
begin
  ...
  SaveDir := IncludeTrailingPathDelimiter(ExtractFilePath(ParamStr(0)) + 'temp\cfgs2\');
...
begin
  ...
  try
    DestinoServidor := Ini.ReadString('UpdateMod', 'destinoserver2', '');
...
procedure TForm20.Label33Click(Sender: TObject);
begin
