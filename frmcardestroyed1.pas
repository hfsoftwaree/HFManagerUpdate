...
var
  frmcardestroyed: Tfrmcardestroyed;
...
procedure Tfrmcardestroyed.BitBtn1Click(Sender: TObject);
begin
Close;
end;

procedure Tfrmcardestroyed.BitBtn2Click(Sender: TObject);
var
  Ini: TIniFile;
...
begin
  ...
  try
    ...
    Ini.WriteString('Servidor 1', 'cardestroyed', Edit6.Text);
    Ini.WriteString('Servidor 2', 'cardestroyed', Edit7.Text);
    Ini.WriteString('Servidor 3', 'cardestroyed', Edit8.Text );
  finally
    // Liberar a memória
    Ini.Free;
  end;
...
procedure Tfrmcardestroyed.FormCreate(Sender: TObject);
var
  Ini: TIniFile;
  CaminhoINI: string;
  Reg: TRegistry;  
begin
  ...
  try
    // Salvar os valores dos componentes no arquivo .INI
    Edit6.Text := Ini.ReadString('Servidor 1', 'cardestroyed', '');
    Edit7.Text := Ini.ReadString('Servidor 2', 'cardestroyed', '');
    Edit8.Text := Ini.ReadString('Servidor 3', 'cardestroyed', '');
  finally
    // Libera a memória
    Ini.Free;
  end;
...
procedure Tfrmcardestroyed.CheckBox2Click(Sender: TObject);
...
procedure Tfrmcardestroyed.Edit6Exit(Sender: TObject);
begin
...
procedure Tfrmcardestroyed.Edit7Exit(Sender: TObject);
begin
...
procedure Tfrmcardestroyed.Edit8Exit(Sender: TObject);
begin
